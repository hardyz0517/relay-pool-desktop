...
const contracts = [
  ...
  ["node", ["--experimental-strip-types", "--test", "scripts/updater-check-coordinator.test.ts"]],
  ["node", ["scripts/dashboard-update-action.test.mjs"]],
  ["node", ["--experimental-strip-types", "--test", "scripts/updater-error-message.test.ts"]],
  ["node", ["--experimental-strip-types", "--test", "scripts/updater-state-flow.test.ts"]],
