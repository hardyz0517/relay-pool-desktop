...
const allowedPathPatterns = [
  ...
  /^src[\\/]features[\\/]stations[\\/]components[\\/]StationGroupChip\.tsx$/,
  ...
  /^src-tauri[\\/]src[\\/]application[\\/](collectors|credentials|pricing)\.rs$/,
  /^src-tauri[\\/]src[\\/]application[\\/]routing_engine[\\/]/,
  /^src-tauri[\\/]src[\\/]persistence[\\/]legacy_import[\\/]import\.rs$/,
  /^src-tauri[\\/]src[\\/]persistence[\\/]stores[\\/](collector_store|credential_store|pricing_store|station_catalog)\.rs$/,
  ...
  /^src-tauri[\\/]src[\\/]services[\\/]group_categories\.rs$/,
  ...
  /^src-tauri[\\/]src[\\/]services[\\/]proxy[\\/]test_support\.rs$/,
  /^src-tauri[\\/]src[\\/]services[\\/]proxy[\\/]scheduler[\\/]eligibility\.rs$/,
  /^src-tauri[\\/]src[\\/]services[\\/]proxy[\\/]scheduler[\\/]explanation\.rs$/,
  /^src-tauri[\\/]src[\\/]services[\\/]proxy[\\/]scheduler[\\/]mod\.rs$/,
  /^src-tauri[\\/]src[\\/]services[\\/]proxy[\\/]scheduler[\\/]multiplier\.rs$/,
  /^src-tauri[\\/]src[\\/]services[\\/]proxy[\\/]scheduler[\\/]types\.rs$/,
