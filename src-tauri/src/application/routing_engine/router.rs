...
use crate::models::routing::{RouteCandidateExplanation, RoutingPolicy};

use super::routing_health::health_is_blocked;
use super::routing_types::{RichRouteCandidate, RouteRequest, RouteSelection};
use super::scheduler::{
    types::{
...
#[cfg(test)]
pub(crate) fn select_route_candidates(
...
pub(crate) fn select_route_candidates_with_scheduler(
    request: &RouteRequest,
    candidates: Vec<RichRouteCandidate>,
    aliases: &[(String, String)],
    ...
    if !matches!(request.policy, RoutingPolicy::AutomaticBalanced) {
        return super::routing_policy::select_route_candidates(request, candidates, aliases);
    }
    ...
    let mapped_model = super::routing_policy::mapped_model(request.model.as_deref(), aliases);
...
fn automatic_candidate_explanation(
    ...
    RouteCandidateExplanation {
        ...
        score: decision
            ...
            .unwrap_or(i64::MAX),
        reasons: super::scheduler::explanation::decision_reasons(decision),
        rejection_reasons: super::scheduler::explanation::rejection_reason_codes(decision),
        mapped_model,
...
#[cfg(test)]
mod tests {
    use super::super::routing_types::{RouteCandidate, RouteCandidateEconomics};
    use super::*;
    ...
    fn automatic_router_uses_supplied_runtime_state_for_sticky_escape() {
        ...
        let scheduler = super::super::scheduler::SchedulerRuntimeState::default();
