...
pub(crate) struct ScoredCandidate {
    ...
    pub(crate) sticky_kind: Option<StickyKind>,
}
...
pub(crate) fn top_k_weights(top_k: &[ScoredCandidate]) -> Vec<f64> {
...
pub(crate) fn weighted_order_without_replacement(
    candidates: &[ScoredCandidate],
    seed: u64,
) -> Vec<ScoredCandidate> {
...
pub(crate) fn move_sticky_candidate_to_front(candidates: &mut Vec<ScoredCandidate>) {
