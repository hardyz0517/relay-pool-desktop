...
pub(crate) struct RuntimeMetricsSnapshot {
    ...
    pub(crate) ttft_ewma_ms: Option<f64>,
    pub(crate) has_ttft: bool,
}
...
pub(crate) struct RuntimeMetricsRegistry {
...
impl RuntimeMetricsRegistry {
    ...
    pub(crate) fn snapshot(&self, key: &str) -> RuntimeMetricsSnapshot {
        let metrics = self
            .metrics
            .lock()
            .expect("runtime metrics registry poisoned");
