...
use super::{
    ...
    queries::{
        channel_status::ChannelStatusQuery, collector_history::CollectorHistoryQuery,
        dashboard_metrics::DashboardMetricsQuery, key_pool::KeyPoolQuery,
        ...
        station_published_status::StationPublishedStatusQuery,
    },
...
pub(crate) struct AppServices {
    ...
    pub(crate) collector_history: Arc<CollectorHistoryQuery>,
...
impl AppServices {
    pub(crate) fn for_runtime(
        ...
        Self::new(
            ...
            Arc::new(CollectorHistoryQuery::new(runtime.clone())),
            routing,
    ...
    pub(crate) fn new(
        ...
        collector_history: Arc<CollectorHistoryQuery>,
