...
const ROUTING_POLICY_V3_STAGED_COLUMNS: &[&str] = &[
    "staged_id",
    "scope",
...
const ROUTING_POLICY_V3_MIGRATION_AUDIT_COLUMNS: &[&str] = &[
    "audit_id",
    "scope",
    "source_config_revision",
    "target_policy_revision",
    ...
    "discarded_fields_json",
    "semantic_changes_json",
    "quality_rebuild_required",
    "created_at_ms",
];
const ROUTING_POLICY_V3_STAGED_RULES: &[FieldRule] = &[FieldRule {
    name: "config_json",
    transform: FieldTransform::BoundedJson,
}];
const ROUTING_POLICY_V3_MIGRATION_AUDIT_RULES: &[FieldRule] = &[
    FieldRule {
        name: "source_fields_json",
        transform: FieldTransform::BoundedJson,
    },
    FieldRule {
        name: "defaulted_fields_json",
        transform: FieldTransform::BoundedJson,
    },
    FieldRule {
        name: "discarded_fields_json",
        transform: FieldTransform::BoundedJson,
    },
    FieldRule {
        name: "semantic_changes_json",
        transform: FieldTransform::BoundedJson,
    },
];
const ROUTING_OBSERVATIONS_COLUMNS: &[&str] = &[
    ...
    "cluster_finalized_at_ms",
    "cluster_finalization_reason",
];
const ROUTING_V3_INGESTION_SEQUENCE_COLUMNS: &[&str] = &["singleton_key", "next_sequence"];
const ROUTING_ATTEMPT_V3_COLUMNS: &[&str] = &[
    "attempt_id",
    "event_id",
    "correlation_id",
    "source",
...
const ROUTING_ATTEMPT_CLUSTER_V3_COLUMNS: &[&str] = &[
    "source",
    "station_key_id",
    "station_key_lifecycle_revision",
    "correlation_id",
...
const ROUTING_ATTEMPT_LATE_AUDIT_V3_COLUMNS: &[&str] = &[
    "audit_id",
    "event_kind",
    "event_id",
    "attempt_id",
...
const ROUTING_QUALITY_GENERATION_V3_COLUMNS: &[&str] = &[
...
const ROUTING_QUALITY_SOURCE_PROFILE_SNAPSHOT_V3_COLUMNS: &[&str] = &[
    "snapshot_id",
    "evaluation_at_ms",
    "input_observation_watermark",
    "quality_policy_revision",
...
const ROUTING_QUALITY_SOURCE_PROFILE_SNAPSHOT_ITEM_V3_COLUMNS: &[&str] = &[
    "snapshot_id",
    "station_key_id",
    "station_key_lifecycle_revision",
...
const ROUTING_QUALITY_GENERATION_CHECKPOINT_V3_COLUMNS: &[&str] = &[
    "quality_generation_id",
    "input_observation_watermark",
    "cursor_station_key_id",
    "cursor_observation_id",
...
const ROUTING_QUALITY_SUMMARY_V3_COLUMNS: &[&str] = &[
    "quality_generation_id",
    "scope",
    "station_key_id",
    "station_key_lifecycle_revision",
...
const ROUTING_QUALITY_SUMMARY_V3_RULES: &[FieldRule] = &[FieldRule {
    name: "summary_json",
    transform: FieldTransform::BoundedJson,
}];
const ROUTING_QUALITY_HEALTH_AXIS_V3_COLUMNS: &[&str] = &[
    "quality_generation_id",
    "scope",
    "station_key_id",
    "station_key_lifecycle_revision",
...
const ROUTING_QUALITY_INCREMENTAL_CHECKPOINT_V3_COLUMNS: &[&str] = &[
    "quality_generation_id",
    "projector",
    "projector_version",
    "scope",
...
const ROUTING_QUALITY_PENDING_CLUSTER_V3_COLUMNS: &[&str] = &[
    "quality_generation_id",
    "source",
    "station_key_id",
    "station_key_lifecycle_revision",
...
const ROUTING_QUALITY_LIFECYCLE_ALIAS_V1_COLUMNS: &[&str] = &[
    "station_key_id",
    "target_lifecycle_revision",
    "reason_code",
    "created_at_ms",
];
const ROUTING_CIRCUIT_CLOCK_V3_COLUMNS: &[&str] =
    &["singleton_key", "watermark_ms", "updated_at_ms"];
const ROUTING_CIRCUIT_STATE_V3_COLUMNS: &[&str] = &[
    "station_key_id",
    "station_key_lifecycle_revision",
    "state",
    "state_revision",
...
const ROUTING_CIRCUIT_EVENT_V3_COLUMNS: &[&str] = &[
    "event_id",
    "effect_kind",
    "source",
    "attempt_id",
...
const ROUTING_CIRCUIT_GENERATION_V3_COLUMNS: &[&str] = &[
    "circuit_generation_id",
    "scope",
    "circuit_policy_revision",
    "circuit_algorithm_version",
    "status",
    ...
    "cursor_station_key_id",
    "cursor_station_key_lifecycle_revision",
    "cursor_reducer_commit_sequence",
    "cursor_event_id",
    "failure_code",
    "created_at_ms",
    "ready_at_ms",
...
const ROUTING_CIRCUIT_GENERATION_CHECKPOINT_V3_COLUMNS: &[&str] = &[
    "circuit_generation_id",
    "input_circuit_event_watermark",
    "cursor_station_key_id",
    "cursor_station_key_lifecycle_revision",
...
const ROUTING_CIRCUIT_STATE_GENERATION_V3_COLUMNS: &[&str] = &[
    "circuit_generation_id",
    "station_key_id",
    "station_key_lifecycle_revision",
    "state",
...
const ROUTING_CIRCUIT_EVENT_APPLIED_GENERATION_V3_COLUMNS: &[&str] = &[
    "circuit_generation_id",
    "event_id",
    "effect_kind",
    "station_key_id",
...
const ROUTING_RUNTIME_GENERATION_COLUMNS: &[&str] = &[
...
const ROUTING_RUNTIME_CUTOVER_MARKER_COLUMNS: &[&str] = &[
    "singleton_key",
    "status",
    "runtime_generation_id",
    "fenced_runtime_generation_id",
    "fence_revision",
    "updated_at_ms",
];
const ROUTING_GENERATION_TRANSITION_AUDIT_COLUMNS: &[&str] = &[
    "transition_id",
    "transition_kind",
...
const ROUTING_GENERATION_QUALIFICATION_COLUMNS: &[&str] = &[
    "runtime_generation_id",
...
const ROUTING_GENERATION_QUALIFICATION_REPORT_COLUMNS: &[&str] = &[
    "runtime_generation_id",
...
const ROUTING_GENERATION_QUALIFICATION_REPORT_RULES: &[FieldRule] = &[
    FieldRule {
        name: "comparison_report_json",
        transform: FieldTransform::BoundedJson,
    },
    FieldRule {
        name: "replay_report_json",
        transform: FieldTransform::BoundedJson,
    },
];
const ROUTING_GENERATION_REPORT_SECRET_COLUMNS: &[&str] =
    &["singleton_key", "secret", "created_at_ms"];
const ROUTING_GENERATION_REPORT_SECRET_RULES: &[FieldRule] = &[FieldRule {
    name: "secret",
    transform: FieldTransform::Exclude,
}];
const ROUTING_CIRCUIT_PERSISTENCE_GATE_V3_COLUMNS: &[&str] = &[
    "station_key_id",
    "station_key_lifecycle_revision",
    "status",
    "reason_code",
...
const ROUTING_CIRCUIT_PERSISTENCE_HEALTH_V3_COLUMNS: &[&str] =
    &["singleton_key", "check_revision", "checked_at_ms"];
const ROUTING_RAW_EVENT_RETENTION_ROLLUP_COLUMNS: &[&str] = &[
    "event_kind",
    "source_kind",
    "outcome_kind",
    "bucket_start_ms",
...
const ROUTING_RAW_EVENT_RETENTION_RUN_COLUMNS: &[&str] = &[
    "run_id",
    "started_at_ms",
    "finished_at_ms",
    "cutoff_at_ms",
...
const TABLES: &[TableCatalog] = &[
    ...
    table(
        ...
        DependencyStage::Routing,
        false,
        ROUTING_POLICY_V3_STAGED_COLUMNS,
        ROUTING_POLICY_V3_STAGED_RULES,
    ),
    table(
        ...
        DependencyStage::Routing,
        false,
        ROUTING_POLICY_V3_MIGRATION_AUDIT_COLUMNS,
        ROUTING_POLICY_V3_MIGRATION_AUDIT_RULES,
    ),
    table(
    ...
    table(
        "routing_v3_ingestion_sequence",
        TablePolicy::Reset,
        DataCategory::DeviceRuntimeState,
        DependencyStage::History,
        false,
        ROUTING_V3_INGESTION_SEQUENCE_COLUMNS,
        &[],
    ),
    table(
        "routing_attempt_v3",
    ...
    table(
        ...
        DependencyStage::History,
        true,
        ROUTING_ATTEMPT_CLUSTER_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        true,
        ROUTING_ATTEMPT_LATE_AUDIT_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_QUALITY_GENERATION_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_QUALITY_SOURCE_PROFILE_SNAPSHOT_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_QUALITY_SOURCE_PROFILE_SNAPSHOT_ITEM_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_QUALITY_GENERATION_CHECKPOINT_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_QUALITY_SUMMARY_V3_COLUMNS,
        ROUTING_QUALITY_SUMMARY_V3_RULES,
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_QUALITY_HEALTH_AXIS_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_QUALITY_INCREMENTAL_CHECKPOINT_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_QUALITY_PENDING_CLUSTER_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_QUALITY_LIFECYCLE_ALIAS_V1_COLUMNS,
        &[],
    ),
    table(
        "routing_circuit_clock_v3",
        TablePolicy::Reset,
        DataCategory::DeviceRuntimeState,
        DependencyStage::History,
        false,
        ROUTING_CIRCUIT_CLOCK_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_CIRCUIT_STATE_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        true,
        ROUTING_CIRCUIT_EVENT_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_CIRCUIT_GENERATION_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_CIRCUIT_GENERATION_CHECKPOINT_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_CIRCUIT_STATE_GENERATION_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_CIRCUIT_EVENT_APPLIED_GENERATION_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::Internal,
        false,
        ROUTING_RUNTIME_GENERATION_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::Internal,
        false,
        ROUTING_RUNTIME_CUTOVER_MARKER_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::Internal,
        false,
        ROUTING_GENERATION_TRANSITION_AUDIT_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::Internal,
        false,
        ROUTING_GENERATION_QUALIFICATION_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::Internal,
        false,
        ROUTING_GENERATION_QUALIFICATION_REPORT_COLUMNS,
        ROUTING_GENERATION_QUALIFICATION_REPORT_RULES,
    ),
    table(
    ...
    table(
        ...
        DependencyStage::Excluded,
        false,
        ROUTING_GENERATION_REPORT_SECRET_COLUMNS,
        ROUTING_GENERATION_REPORT_SECRET_RULES,
    ),
    table(
        ...
        DependencyStage::Internal,
        false,
        ROUTING_CIRCUIT_PERSISTENCE_GATE_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::Internal,
        false,
        ROUTING_CIRCUIT_PERSISTENCE_HEALTH_V3_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        true,
        ROUTING_RAW_EVENT_RETENTION_ROLLUP_COLUMNS,
        &[],
    ),
    table(
        ...
        DependencyStage::History,
        false,
        ROUTING_RAW_EVENT_RETENTION_RUN_COLUMNS,
        &[],
    ),
    table(
...
mod tests {
    ...
    fn catalog_matches_required_policy_matrix_for_configuration_and_runtime_boundaries() {
        ...
        assert_eq!(
            table_catalog("routing_circuit_clock_v3").unwrap().policy,
            TablePolicy::Reset
        );
        assert_eq!(
            table_catalog("routing_raw_event_retention_rollup")
                .unwrap()
                .policy,
            TablePolicy::OptionalHistory
        );
        assert_eq!(
            table_catalog("routing_raw_event_retention_run")
                .unwrap()
                .policy,
            TablePolicy::Reset
        );
