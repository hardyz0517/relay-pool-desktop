...
const TRUSTED_INDEXES_V1: &[&str] = &[
    ...
    "idx_routing_policy_v3_staged_status",
    "idx_routing_observations_v3_ingestion_sequence",
    "idx_routing_observations_v3_event_id",
    "idx_routing_observations_v3_attempt_id",
    "idx_routing_observations_v3_attempt_identity",
    "idx_routing_observations_v3_key_event_time",
    "idx_routing_observations_v3_source_cursor",
    "idx_routing_attempt_v3_key_cursor",
    "idx_routing_attempt_v3_correlation",
    "idx_routing_attempt_cluster_v3_no_attempts",
    "idx_routing_attempt_cluster_v3_pending",
    "idx_routing_quality_summary_v3_generation_revision",
    "idx_routing_circuit_state_v3_admission",
    "idx_routing_circuit_event_v3_key_sequence",
    "idx_routing_circuit_event_v3_ingestion_sequence",
    "idx_routing_circuit_event_v3_applied_sequence",
    "idx_routing_circuit_state_generation_v3_state",
    "idx_routing_runtime_generation_one_active",
    "idx_routing_runtime_generation_one_fencing",
    "idx_routing_runtime_generation_status",
    "idx_routing_generation_transition_audit_target",
    "idx_routing_raw_event_retention_run_finished",
...
const TRUSTED_TRIGGERS_V1: &[&str] = &[
    ...
    "routing_observations_v3_assign_ingestion_sequence",
    "routing_observations_v3_advance_ingestion_sequence",
    "routing_observations_v3_immutable",
    "routing_observations_v3_validate_insert",
    "routing_attempt_v3_assign_ingestion_sequence",
    "routing_attempt_v3_advance_ingestion_sequence",
    "routing_quality_generation_v3_immutable_identity",
    "routing_circuit_events_v3_assign_ingestion_sequence",
    "routing_circuit_events_v3_advance_ingestion_sequence",
    "routing_circuit_generation_v3_immutable_identity",
    "routing_runtime_generation_v3_immutable_identity",
    "routing_runtime_generation_v3_legal_status_transition",
    "routing_generation_qualification_no_update",
    "routing_generation_qualification_no_delete",
    "routing_generation_transition_audit_no_update",
    "routing_generation_transition_audit_no_delete",
    "routing_generation_qualification_report_no_update",
    "routing_generation_qualification_report_no_delete",
    "routing_generation_qualification_v2_no_update",
    "routing_generation_qualification_v2_no_delete",
    "routing_generation_qualification_report_v2_no_update",
    "routing_generation_qualification_report_v2_no_delete",
    "routing_attempt_late_audit_v3_no_update",
    "routing_attempt_late_audit_v3_no_delete",
    "routing_attempt_v3_reject_late_admission",
    "routing_attempt_cluster_v3_finalized_fence",
    "routing_quality_source_profile_snapshot_item_v3_no_late_insert",
    "routing_quality_source_profile_snapshot_v3_no_update",
    "routing_quality_source_profile_snapshot_v3_no_delete",
    "routing_quality_source_profile_snapshot_item_v3_no_update",
    "routing_quality_source_profile_snapshot_item_v3_no_delete",
    "routing_quality_generation_v3_profile_snapshot_immutable",
