...
pub(crate) const BUILTIN_MODEL_BASE_PRICE_CHECKED_AT: &str = "2026-08-01";
pub(crate) const BUILTIN_MODEL_BASE_PRICES: &[BuiltinModelBasePrice] = &[
    BuiltinModelBasePrice {
        ...
        input_price: 3.0,
        output_price: 15.0,
        source_url: "https://github.com/Wei-Shaw/sub2api/blob/b22f73e725236790f97d89bf0c3b908a48e591d5/backend/resources/model-pricing/model_prices_and_context_window.json",
