...
| `ChannelMonitorRun` DTO and `list_channel_monitor_runs` IPC | read-only compatibility | compatibility IPC only; product frontend has no consumer | one release observation cycle | 18 follow-up | remove with `docs/archive/plans/2026-07-29-status-monitoring-legacy-table-removal.md` |
...
`docs/archive/plans/2026-07-29-status-monitoring-legacy-table-removal.md`
