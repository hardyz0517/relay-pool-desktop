...
- 计划：`docs/archive/plans/2026-07-29-status-monitoring-refactor.md`
- 资格记录：`docs/audits/status-monitoring-qualification.md`
- 边界清单：`docs/audits/status-monitoring-boundary-manifest.json`
...
- 本规范的计划内本地确定性实现与验证已完成；详细执行顺序、验收证据与仍需授权的发布 gate 见 `docs/archive/plans/2026-07-29-status-monitoring-refactor.md`、`docs/audits/status-monitoring-qualification.md`、PRODUCT_MODEL 和 PROJECT_PLAN。
