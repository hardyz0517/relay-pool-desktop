...
| Latest compatibility schema | schema `55` |
| Latest SQL migration ledger | schema `55` |
...
schema 15, legacy secrets
  ...
  -> structural migrations to schema 55
  -> final verification
...
schema 17-54, secret_format_version 1
  -> structural migrations to schema 55
  -> final verification

schema 55, secret_format_version 1
  -> final verification
```
