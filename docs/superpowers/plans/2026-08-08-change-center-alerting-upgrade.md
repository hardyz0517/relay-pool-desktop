...
- Create: `docs/superpowers/audits/change-center-alerting-baseline.md`
- Create: `docs/superpowers/audits/change-center-alerting-deletion-ledger.md`
- Create: `docs/superpowers/audits/change-center-alerting-boundary-manifest.json`
...
- Create: `docs/superpowers/plans/YYYY-MM-DD-change-center-legacy-table-removal.md`（观察期结束后才创建）
...
- Create: `docs/superpowers/audits/change-center-alerting-qualification.md`
- Create: `docs/superpowers/audits/change-center-alerting-acceptance-matrix.md`
