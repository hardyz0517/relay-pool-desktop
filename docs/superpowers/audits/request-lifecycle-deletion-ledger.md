...
- Current reruns of `scripts\verify-local-routing-lifecycle.ps1` must include `-AuthorizeLocalClientSmoke`; the authorization switch was added after this historical evidence to prevent accidental synthetic traffic.
