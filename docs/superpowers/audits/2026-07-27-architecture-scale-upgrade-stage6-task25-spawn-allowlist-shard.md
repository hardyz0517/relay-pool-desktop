...
- `git diff --name-only | rg "^(src-tauri/src/persistence|src-tauri/migrations|docs/superpowers/audits/persistence-v2-boundary-manifest\\.json)"` returned no matches.
