...
| Create `provider-capability-matrix.json` | `docs/superpowers/audits/provider-capability-matrix.json` declares Sub2API, NewAPI, and OpenAI-compatible descriptors and collector/remote-key/authorization capability status. | Pass |
