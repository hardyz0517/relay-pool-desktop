...
- Supported capabilities have complete conformance fixture coverage in `docs/superpowers/audits/provider-capability-matrix.json` and `src-tauri/tests/fixtures/providers/manifest.json`.
