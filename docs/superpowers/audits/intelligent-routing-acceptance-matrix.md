...
| 14 | 13, 19 | `node scripts/intelligent-routing-qualification.mjs`; `docs/superpowers/audits/intelligent-routing-qualification.md` |
...
| 24 | 1, 17 | `node scripts/intelligent-routing-architecture.test.mjs`; `docs/superpowers/audits/intelligent-routing-boundary-manifest.json` |
...
| 28 | 20 | `docs/superpowers/audits/intelligent-routing-deletion-ledger.md` (all rows have a closed disposition) |
...
| 69 | 1, 16, 18 | `node scripts/intelligent-routing-architecture.test.mjs`; `node scripts/routing-cutover-schema.test.mjs`; `docs/superpowers/audits/intelligent-routing-boundary-manifest.json` |
...
| 78 | 5, 8, 19 | `node scripts/intelligent-routing-qualification.mjs`; `pnpm.cmd test:contracts`; `docs/superpowers/audits/intelligent-routing-qualification.md` |
