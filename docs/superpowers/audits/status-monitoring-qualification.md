...
- `scripts/run-monitoring-soak.ps1`
  - Runs deterministic local monitoring suites repeatedly for the requested duration and writes `docs/superpowers/audits/status-monitoring-soak-latest.json`.
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/run-monitoring-soak.ps1 -DurationMinutes 1 -Quick` passed and wrote `docs/superpowers/audits/status-monitoring-soak-latest.json`.
- `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/run-monitoring-soak.ps1 -DurationMinutes 60 -OutputPath docs/superpowers/audits/status-monitoring-soak-60m-latest.json` passed and wrote `docs/superpowers/audits/status-monitoring-soak-60m-latest.json`.
  - Started: 2026-07-30T01:26:35.9157847+08:00.
  - Finished: 2026-07-30T02:26:38.8829128+08:00.
  - Iterations: 985.
  - Failures: 0.
- `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/run-monitoring-soak.ps1 -DurationMinutes 60 -ReleaseBuild -MixedProviderWorkload -OutputPath docs/superpowers/audits/status-monitoring-soak-release-mixed-60m-latest.json` passed and wrote `docs/superpowers/audits/status-monitoring-soak-release-mixed-60m-latest.json`.
