...
This audit is the deletion and wiring ledger for `docs/superpowers/plans/2026-08-03-dead-code-reliability-upgrade.md`.
...
| `git diff --check -- docs/superpowers/audits/2026-08-03-dead-code-inventory.md scripts/dead-code-inventory.mjs package.json` | 0 | clean; Git reports only its normal LF/CRLF normalization note for `package.json` |
...
| closeout document | `wire` | Added `docs/superpowers/audits/2026-08-03-dead-code-closeout.md` with baseline/current counts, verification, remaining warning classes, release limitations, and follow-up guidance. |
