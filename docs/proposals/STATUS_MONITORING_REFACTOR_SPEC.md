...
- 计划：`docs/superpowers/plans/2026-07-29-status-monitoring-refactor.md`
- 资格记录：`docs/superpowers/audits/status-monitoring-qualification.md`
- 边界清单：`docs/superpowers/audits/status-monitoring-boundary-manifest.json`
- 删除台账：`docs/superpowers/audits/status-monitoring-deletion-ledger.md`
- 后续 legacy 删除票据：`docs/superpowers/plans/2026-07-29-status-monitoring-legacy-table-removal.md`
...
- 本规范的计划内本地确定性实现与验证已完成；详细执行顺序、验收证据与仍需授权的发布 gate 见 `docs/superpowers/plans/2026-07-29-status-monitoring-refactor.md`、`docs/superpowers/audits/status-monitoring-qualification.md`、PRODUCT_MODEL 和 PROJECT_PLAN。
