...
**Approved design:** `docs/archive/specs/2026-07-17-local-routing-reliability-upgrade-design.md`
...
```powershell
git log -1 --oneline -- docs/archive/specs/2026-07-17-local-routing-reliability-upgrade-design.md
