...
- Read first:
  ...
  - `docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage3-progress.md`
  - this file
- Run drift intake:
...
- Modify: `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage4-progress.md`
...
**Files:**
- Create: `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage4-progress.md`
...
```powershell
git add -- docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage4-progress.md
