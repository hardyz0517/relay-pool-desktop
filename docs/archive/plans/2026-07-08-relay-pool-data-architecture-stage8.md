...
- Read first:
  ...
  - `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage7-progress.md`
  - this file
- Run drift intake:
...
- Modify: `docs/audits/relay-pool-field-ownership-ledger.md`
- Create: `scripts/compatibility-field-review.test.mjs`
- Create: `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage8-progress.md`

## Task 1: Commit Stage 8 Plan

**Files:**
- Create: `docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage8.md`

- [ ] **Step 1: Scan for placeholders**

```powershell
$patterns = @('TB' + 'D', 'TO' + 'DO', 'lat' + 'er', 'fill' + ' in', 'Similar' + ' to')
Select-String -Path docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage8.md -Pattern $patterns -CaseSensitive
```
...
```powershell
git add -- docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage8.md
git diff --cached --name-only
git commit -m "docs: add data architecture stage8 plan"
```

Expected staged path: `docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage8.md`.
...
```powershell
git add -- docs/audits/relay-pool-field-ownership-ledger.md
git diff --cached --name-only
...
```powershell
git add -- docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage8-progress.md
git diff --cached --name-only
