...
**Approved design:** `docs/archive/specs/2026-07-18-persistence-architecture-v2-upgrade-design.md`
...
| `docs/audits/persistence-v2-*.json` | Versioned schema/field/boundary/released-profile manifests |
...
**Files:**
- Create: `docs/audits/persistence-v2-boundary-manifest.json`
- Create: `docs/audits/persistence-v2-field-ledger.json`
- Create: `docs/audits/persistence-v2-released-schema-manifest.json`
- Create: `docs/archive/audits/2026-07-18-persistence-v2-baseline.md`
...
```powershell
git add -- docs/audits/persistence-v2-boundary-manifest.json docs/audits/persistence-v2-field-ledger.json docs/audits/persistence-v2-released-schema-manifest.json docs/archive/audits/2026-07-18-persistence-v2-baseline.md
...
- Modify: `src-tauri/src/commands/mod.rs`
- Modify: `src-tauri/src/lib.rs`
- Modify: `docs/audits/persistence-v2-boundary-manifest.json`
...
pnpm.cmd test:contracts
cargo check --manifest-path src-tauri/Cargo.toml
git add -- src-tauri/src/application/app_services.rs src-tauri/src/application/mod.rs src-tauri/src/commands src-tauri/src/lib.rs docs/audits/persistence-v2-boundary-manifest.json src-tauri/tests/persistence_architecture.rs
...
git diff -- src-tauri/tests/persistence_upgrade/fixtures docs/audits/persistence-v2-released-schema-manifest.json
```
...
git add -- scripts/build-persistence-v2-fixtures.ps1 src-tauri/src/persistence/legacy_import src-tauri/tests/persistence_upgrade.rs src-tauri/tests/persistence_upgrade/fixtures docs/audits/persistence-v2-released-schema-manifest.json
...
- Create: `src-tauri/src/persistence/differential_tests.rs`
- Create: `docs/archive/audits/2026-07-18-persistence-v2-qualification.md`
...
```powershell
git add -- src-tauri/tests/persistence_fault_matrix.rs src-tauri/src/persistence/performance_tests.rs src-tauri/src/persistence/differential_tests.rs docs/archive/audits/2026-07-18-persistence-v2-qualification.md scripts/release-verification-entrypoint.test.mjs scripts/run-contract-tests.mjs
...
pnpm.cmd build
cargo check --manifest-path src-tauri/Cargo.toml
$manifest = Get-Content -Raw docs/audits/persistence-v2-boundary-manifest.json | ConvertFrom-Json
$released = Get-Content -Raw docs/audits/persistence-v2-released-schema-manifest.json | ConvertFrom-Json
git add -- src-tauri/src/services/database.rs src-tauri/src/services/mod.rs src-tauri/src/lib.rs src-tauri/Cargo.toml src-tauri/Cargo.lock src-tauri/tests/persistence_architecture.rs src-tauri/src/persistence/differential_tests.rs docs/audits/persistence-v2-boundary-manifest.json .sqlx
...
**Files:**
- Create: `docs/audits/2026-07-18-persistence-v2-release-evidence.md`
...
```powershell
git add -- docs/audits/2026-07-18-persistence-v2-release-evidence.md
git status --short
git diff --cached --name-only
git diff --cached --check
cargo fmt --manifest-path src-tauri/Cargo.toml -- --check
