...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement stage plans task-by-task. Every worker must read `docs/archive/specs/2026-07-07-relay-pool-data-architecture-master-spec.md` before editing code.
...
1. `docs/archive/specs/2026-07-07-relay-pool-data-architecture-master-spec.md`
2. `docs/archive/plans/2026-07-07-relay-pool-data-architecture-master-plan.md`
3. `docs/audits/relay-pool-field-ownership-ledger.md`
4. 当前 stage 的具体计划，例如 `docs/archive/plans/2026-07-07-relay-pool-data-architecture-stage0.md`
...
- 新字段必须先登记到 `docs/audits/relay-pool-field-ownership-ledger.md`，默认状态为 `pending audit`。
...
- `docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage0-baseline.md`
