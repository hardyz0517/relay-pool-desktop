...
Run: `git diff -- src/features/dashboard/DashboardPage.tsx scripts/dashboard-recent-usage-layout.test.mjs docs/archive/specs/2026-07-10-dashboard-recent-usage-empty-state-design.md docs/archive/plans/2026-07-10-dashboard-recent-usage-empty-state.md`
