...
- `docs/audits/status-monitoring-boundary-manifest.json` has no unexpired production exceptions except this follow-up.
...
6. Update `docs/specs/STATUS_MONITORING_REFACTOR_SPEC.md`, `docs/PROJECT_PLAN.md`, and release notes to mark the legacy observation cycle closed.
