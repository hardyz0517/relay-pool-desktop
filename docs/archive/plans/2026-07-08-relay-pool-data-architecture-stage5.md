...
- Read first:
  ...
  - `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage4-progress.md`
  - this file
- Run drift intake:
...
- Create: `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage5-progress.md`
...
**Files:**
- Create: `docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage5.md`
...
Select-String -Path docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage5.md -Pattern $patterns -CaseSensitive
```
...
```powershell
git add -- docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage5.md
...
```text
docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage5.md
```
...
```powershell
git add -- docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage5-progress.md
git diff --cached --name-only
