...
**Goal:** Implement the unified billing and pricing architecture from `docs/archive/specs/2026-07-10-billing-pricing-architecture-design.md`.
...
- Read first:
  ...
  - `docs/archive/specs/2026-07-10-billing-pricing-architecture-design.md`
...
```powershell
git add -- docs/archive/specs/2026-07-10-billing-pricing-architecture-design.md
git diff --cached --name-only
git commit -m "docs: clarify billing pricing spec edge cases"
```

Expected staged path: `docs/archive/specs/2026-07-10-billing-pricing-architecture-design.md`.
...
- Create: `docs/archive/plans/2026-07-10-billing-pricing-architecture.md`

- [ ] Step 1: Scan for incomplete markers and forbidden architecture-source terms.

```powershell
$patterns = @('TB' + 'D', 'TO' + 'DO', 'FIX' + 'ME')
Select-String -Path docs/archive/plans/2026-07-10-billing-pricing-architecture.md -Pattern $patterns -CaseSensitive
```
...
```powershell
git add -- docs/archive/plans/2026-07-10-billing-pricing-architecture.md
git diff --cached --name-only
git commit -m "docs: add billing pricing architecture plan"
```

Expected staged path: `docs/archive/plans/2026-07-10-billing-pricing-architecture.md`.
