...
Run: `git diff -- src-tauri/src/commands/mod.rs src/lib/api/stationKeys.ts src/lib/types/stationKeys.ts src/features/key-pool/KeyPoolPage.tsx scripts/key-pool-connectivity-dialog.test.mjs docs/archive/plans/2026-07-14-key-connectivity-streaming.md`
