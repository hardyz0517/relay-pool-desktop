...
- Create: `docs/specs/2026-07-29-portable-migration-crypto-format-adr.md`
...
- Modify: `docs/audits/architecture-scale-dependency-lifecycle.json`
- Modify only if required by advisory result: `docs/audits/dependency-advisory-exceptions.json`
...
- Modify: `docs/specs/2026-07-29-portable-migration-crypto-format-adr.md`
- Modify: `docs/audits/architecture-scale-dependency-lifecycle.json`
- Modify: `src-tauri/src/application/data_migration/mod.rs`
...
```powershell
git add -- docs/SECURITY_EXPORT_IMPORT.md docs/README.md docs/PROJECT_PLAN.md README.md docs/release/PORTABLE_MIGRATION_SMOKE_CHECKLIST.md docs/specs/2026-07-29-portable-migration-crypto-format-adr.md docs/audits/architecture-scale-dependency-lifecycle.json src-tauri/src/application/data_migration/mod.rs src-tauri/src/ipc/dto/data_migration.rs scripts/verify.ps1 scripts/release-verification-entrypoint.test.mjs
