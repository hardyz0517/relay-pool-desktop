...
- Read first:
  ...
  - `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage6-progress.md`
  - this file
- Run drift intake:
...
- Create: `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage7-progress.md`
...
**Files:**
- Create: `docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage7.md`

- [ ] **Step 1: Scan for placeholders**

```powershell
$patterns = @('TB' + 'D', 'TO' + 'DO', 'lat' + 'er', 'fill' + ' in', 'Similar' + ' to')
Select-String -Path docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage7.md -Pattern $patterns -CaseSensitive
```
...
```powershell
git add -- docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage7.md
git diff --cached --name-only
git commit -m "docs: add data architecture stage7 plan"
```

Expected staged path: `docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage7.md`.
...
```powershell
git add -- docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage7-progress.md
git diff --cached --name-only
