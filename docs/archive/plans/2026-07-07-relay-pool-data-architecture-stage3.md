...
- Modify: `docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage3-progress.md`
...
Create `docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage3-progress.md`:
...
```powershell
git add -- scripts/group-facts-projection.test.mjs docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage3-progress.md
