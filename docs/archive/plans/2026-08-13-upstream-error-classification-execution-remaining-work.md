...
适用范围：汇总会话 `019ff0a9-246c-7972-9048-d69d81e998c9` 及其续接会话 `019ff60e-2d4d-70b0-8b8b-708a17fef8bf` 的已完成证据和仍需完成的实质工作。本文件补充而不替代 [`2026-08-13-upstream-error-classification-retry-closure.md`](../../plans/2026-08-13-upstream-error-classification-retry-closure.md)。实施以 `AGENTS.md`、当前代码、自动化契约和 [`docs/README.md`](../../README.md) 为准。
