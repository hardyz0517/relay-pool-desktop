...
适用范围：本计划汇总会话 `019ff0a9-246c-7972-9048-d69d81e998c9` 与其续接会话 `019ff60e-2d4d-70b0-8b8b-708a17fef8bf` 的已完成证据和仍未完成的实质工作。它补充而不替代 [`2026-08-13-upstream-error-classification-retry-closure.md`](../../plans/2026-08-13-upstream-error-classification-retry-closure.md) 的不变量、任务定义和最终验收门禁。
