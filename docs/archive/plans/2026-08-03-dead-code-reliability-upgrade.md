...
- `docs/archive/plans/2026-07-31-schema15-upgrade-debt-cleanup.md`
...
- Create: `docs/archive/audits/2026-08-03-dead-code-inventory.md`
...
git diff --check -- docs/archive/audits/2026-08-03-dead-code-inventory.md scripts/dead-code-inventory.mjs package.json
```
...
- Create: `docs/archive/audits/2026-08-03-dead-code-closeout.md`
- Modify: `package.json`
