...
- Read first:
  ...
  - `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage5-progress.md`
  - this file
- Run drift intake:
...
- Create: `docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage6-progress.md`

## Task 1: Stage 6 Plan And Stale Guard Intake

**Files:**
- Create: `docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage6.md`
- Modify: `scripts/add-provider-key-groups.test.mjs`
...
Select-String -Path docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage6.md -Pattern $patterns -CaseSensitive
git add -- docs/archive/plans/2026-07-08-relay-pool-data-architecture-stage6.md
...
```powershell
git add -- docs/archive/audits/2026-07-08-relay-pool-data-architecture-stage6-progress.md
git diff --cached --name-only
