...
- 先读总 SPEC：`docs/archive/specs/2026-07-07-relay-pool-data-architecture-master-spec.md`
- 先读总计划：`docs/archive/plans/2026-07-07-relay-pool-data-architecture-master-plan.md`
- 先读字段归属清单：`docs/audits/relay-pool-field-ownership-ledger.md`
...
- `docs/archive/specs/2026-07-07-relay-pool-data-architecture-master-spec.md`
- `docs/archive/plans/2026-07-07-relay-pool-data-architecture-master-plan.md`
- `docs/archive/plans/2026-07-07-relay-pool-data-architecture-stage0.md`
- `docs/audits/relay-pool-field-ownership-ledger.md`

推荐提交：

```powershell
git add -- docs/archive/specs/2026-07-07-relay-pool-data-architecture-master-spec.md docs/archive/plans/2026-07-07-relay-pool-data-architecture-master-plan.md docs/archive/plans/2026-07-07-relay-pool-data-architecture-stage0.md docs/audits/relay-pool-field-ownership-ledger.md
...
- 新增字段必须先进入 `docs/audits/relay-pool-field-ownership-ledger.md`，标注为 `canonical fact`、`evidence/history`、`current projection`、`compatibility cache` 或 `unknown pending audit`。
...
- Create: `docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage0-baseline.md`
...
- 字段归属清单：记录 `docs/audits/relay-pool-field-ownership-ledger.md` 是否有新增/变更。
...
```powershell
git add -- docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage0-baseline.md
...
Append to `docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage0-baseline.md`:
...
```powershell
git add -- scripts/data-architecture-field-ownership.test.mjs docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage0-baseline.md
...
**Files:**
- Modify: `docs/archive/audits/2026-07-07-relay-pool-data-architecture-stage0-baseline.md`
