...
- Read `docs/archive/specs/2026-07-13-station-website-api-url-separation-design.md` before starting.
...
```powershell
rg -n "api_key|cookie|password|Authorization" docs/archive/specs/2026-07-13-station-website-api-url-separation-design.md docs/PROJECT_PLAN.md README.md
```
