...
function workspace(): RoutingWorkspaceView {
  return {
    ...
    candidates: ["key-1", "key-2", "key-3"].map((stationKeyId) => ({
      stationKeyId,
      ...
      score: { "key-1": 9_600, "key-3": 8_200 }[stationKeyId] ?? null,
      scoreDetails: null,
      ...
      facts: [],
    })) as RoutingWorkspaceView["candidates"],
    summary: {
      totalCandidateCount: 3,
      currentPageCandidateCount: 3,
      participatingCandidateCount: 3,
      nonParticipatingCandidateCount: 0,
      openCircuitCandidateCount: 0,
      recoveryEligibleCandidateCount: 0,
      readModelUnavailableCandidateCount: 0,
      lastDecisionAt: null,
    },
