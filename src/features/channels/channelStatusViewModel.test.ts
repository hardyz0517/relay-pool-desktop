...
function fixtureRow(): ChannelStatusRow {
  return {
    ...
    hourlyBuckets: [
      {
        ...
        endMs: 2,
        state: "available",
        counts: { total: 1, available: 1, degraded: 0, unavailable: 0, skipped: 0, excluded: 0 },
      ...
      },
      {
        ...
        endMs: 3,
        state: "missing",
        counts: { total: 0, available: 0, degraded: 0, unavailable: 0, skipped: 0, excluded: 0 },
    ...
    selectedWindow: {
      ...
      startMs: 1,
      endMs: 3,
      counts: { total: 10, available: 8, degraded: 1, unavailable: 1, skipped: 0, excluded: 0 },
