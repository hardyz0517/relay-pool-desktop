  ...
  memoryBalanceSnapshots = [
    {
      ...
      todayBaseConsumption: 1.25,
      totalBaseConsumption: 38.4,
    ...
    },
    {
      ...
      todayBaseConsumption: 0.45,
      totalBaseConsumption: 12.8,
...
function coerceBalanceSnapshot(input: unknown): BalanceSnapshot {
  ...
  return {
    ...
    todayBaseConsumption: candidate.todayBaseConsumption ?? null,
    totalBaseConsumption: candidate.totalBaseConsumption ?? null,
    ...
    accountConcurrencyLimit: candidate.accountConcurrencyLimit ?? null,
