...
import {
  ...
  redeemStationCode as redeemStationCodeBinding,
  ...
  listModelPriceSyncCatalog as listModelPriceSyncCatalogBinding,
  getModelPriceSyncState as getModelPriceSyncStateBinding,
  saveModelPriceSyncConfig as saveModelPriceSyncConfigBinding,
...
export class DesktopBackend implements BackendClient {
  ...
  readonly collectors = {
    ...
    redeemStationCode: (stationId: string, code: string) => redeemStationCodeBinding({ stationId, code }),
  ...
  readonly economics = {
    ...
    listModelPriceSyncCatalog: () => listModelPriceSyncCatalogBinding(),
    upsertModelBasePrice: (input: Parameters<BackendClient["economics"]["upsertModelBasePrice"]>[0]) =>
      upsertModelBasePriceBinding(input),
    deleteModelBasePrice: (id: string) => deleteModelBasePriceBinding({ id }),
    resetModelBasePricesToBuiltins: () => resetModelBasePricesToBuiltinsBinding(),
    getModelPriceSyncState: () => getModelPriceSyncStateBinding(),
    saveModelPriceSyncConfig: (input: Parameters<BackendClient["economics"]["saveModelPriceSyncConfig"]>[0]) =>
      saveModelPriceSyncConfigBinding(input),
    syncModelPrices: (force = false) => syncModelPricesBinding({ force }),
    reloadModelPriceCatalog: () => reloadModelPriceCatalogBinding(),
    openModelPriceCatalogDirectory: () => openModelPriceCatalogDirectoryBinding(),
