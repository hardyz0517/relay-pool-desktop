...
export class DemoBackend implements BackendClient {
  ...
  readonly economics: BackendClient["economics"] = {
    ...
    listModelPriceSyncCatalog: () => this.rejectUnsupported("economics.model_price_sync"),
    upsertModelBasePrice: () => this.rejectUnsupported("economics"),
    deleteModelBasePrice: (_id: string) => this.rejectUnsupported("economics"),
    resetModelBasePricesToBuiltins: () => this.rejectUnsupported("economics"),
    getModelPriceSyncState: () => this.rejectUnsupported("economics.model_price_sync"),
    saveModelPriceSyncConfig: () => this.rejectUnsupported("economics.model_price_sync"),
    syncModelPrices: () => this.rejectUnsupported("economics.model_price_sync"),
    reloadModelPriceCatalog: () => this.rejectUnsupported("economics.model_price_sync"),
    openModelPriceCatalogDirectory: () => this.rejectUnsupported("economics.model_price_sync"),
  ...
  readonly routing: BackendClient["routing"] = {
    ...
    getModelMappingWorkspace: () => this.rejectUnsupported("routing.model_mapping"),
    getModelMappingDocument: () => this.rejectUnsupported("routing.model_mapping"),
    validateModelMappingDocument: () => this.rejectUnsupported("routing.model_mapping"),
    applyModelMappingDocument: () => this.rejectUnsupported("routing.model_mapping"),
    restoreModelMappingRevision: () => this.rejectUnsupported("routing.model_mapping"),
    simulateModelMapping: () => this.rejectUnsupported("routing.model_mapping"),
    ...
    listErrorRateHistory: () => this.rejectUnsupported("routing.error_rate_history"),
    loadRoutingPolicy: () => this.rejectUnsupported("routing.policy"),
    applyRoutingPolicyDocument: () => this.rejectUnsupported("routing.policy"),
