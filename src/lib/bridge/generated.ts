...
export type RoutingPolicyPublicationStatusDto = {
  revision: number;
  policyGenerationId: string | null;
  status: "staged" | "ready" | "failed" | "active" | "expired";
  failureCode: "generation_build_failed" | "generation_superseded" | "generation_qualification_failed" | "generation_cutover_failed" | "generation_failed" | null;
  updatedAtMs: number;
  terminal: boolean;
};
