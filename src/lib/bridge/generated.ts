...
export type UpsertBalanceSnapshotInputDto = {
  ...
  observedAtMs?: number | null; validUntilMs?: number | null;
  evidenceProfileVersion?: string | null; spendabilityReasonCode?: string | null;
};

export type BalanceSnapshotDto = Omit<UpsertBalanceSnapshotInputDto, "id" | "scope" | "status"> & {
  id: string; scope: string; balanceKind: string; status: string; createdAt: string; updatedAt: string;
  evidenceConfidence: "confirmed" | "probable" | "unknown" | "conflicting" | string;
  spendabilityAuthority: "authoritative" | "advisory" | "unknown" | string;
  observedAtMs: number | null; validUntilMs: number | null;
  evidenceProfileVersion: string | null; spendabilityReasonCode: string | null;
...
export type RequestLogDto = {
  ...
  durationMs: number | null; method: string; path: string; model: string | null;
  resolvedUpstreamModel: string | null; stream: boolean;
...
export type RoutingCandidateParticipationReasonDto = "ready" | "administratively_disabled" | "planner_excluded" | "planner_unavailable" | "candidate_limit_exceeded" | "circuit_persistence_unavailable" | "circuit_open_cooldown" | "circuit_recovery_ready" | "circuit_half_open_idle" | "circuit_half_open_lease_occupied";
