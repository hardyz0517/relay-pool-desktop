...
export type CommonLoginProfileDto = {
  id: string;
  email: string;
  passwordPresent: boolean;
...
export type CommonLoginProfileIdInputDto = {
  id: string;
};

export type UpsertCommonLoginProfileInputDto = {
  id?: string | null;
  email: string;
...
export function listCommonLoginProfiles(input: EmptyInputDto = {}): Promise<CommonLoginProfileDto[]> {
